            ...
            <Table className="billing__table">
              <TableHeader className="billing__table-header">
                <TableRow className="billing__table-header-row ">
                  <TableHead className="billing__table-cell text-center">Data</TableHead>
                  <TableHead className="billing__table-cell text-center">Amount</TableHead>
                  <TableHead className="billing__table-cell text-center">
                    Payment Method
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody className="billing__table-body">
                {filterData?.length > 0 ? (
                  filterData?.map((transaction) => (
                    <TableRow
                      className="billing__table-row text-center"
